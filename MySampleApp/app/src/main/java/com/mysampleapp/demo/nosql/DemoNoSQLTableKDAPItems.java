...
public class DemoNoSQLTableKDAPItems extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableKDAPItems.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKey extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() throws AmazonClientException {
            ...
            result = mapper.load(KDAPItemsDO.class, 1111500000.0);
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLKDAPItemsResult(result));
    ...
    public class DemoScanWithFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<KDAPItemsDO> results;
        private Iterator<KDAPItemsDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#answer", "answer");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":Minanswer",
                new AttributeValue().withS("demo-answer-500000"));
            final DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
                .withFilterExpression("#answer > :Minanswer")
                .withExpressionAttributeNames(filterExpressionAttributeNames)
                .withExpressionAttributeValues(filterExpressionAttributeValues);

            results = mapper.scan(KDAPItemsDO.class, scanExpression);
            if (results != null) {
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<KDAPItemsDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final KDAPItemsDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLKDAPItemsResult(item));
            itemsRetrieved++;
    ...
    public DemoNoSQLTableKDAPItems() {
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final KDAPItemsDO firstItem = new KDAPItemsDO();

        firstItem.setID(DemoSampleDataGenerator.getRandomSampleNumber());
        firstItem.setAnswer(
            DemoSampleDataGenerator.getRandomSampleString("answer"));
        firstItem.setImageUrl(
            DemoSampleDataGenerator.getRandomSampleString("imageUrl"));
        firstItem.setLabel(
            DemoSampleDataGenerator.getRandomSampleString("label"));
        firstItem.setQuestion(
            DemoSampleDataGenerator.getRandomSampleString("question"));
        ...
        final KDAPItemsDO[] items = new KDAPItemsDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final KDAPItemsDO item = new KDAPItemsDO();
            item.setID(DemoSampleDataGenerator.getRandomSampleNumber());
            item.setAnswer(DemoSampleDataGenerator.getRandomSampleString("answer"));
            item.setImageUrl(DemoSampleDataGenerator.getRandomSampleString("imageUrl"));
            item.setLabel(DemoSampleDataGenerator.getRandomSampleString("label"));
            item.setQuestion(DemoSampleDataGenerator.getRandomSampleString("question"));
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        // colliding with DynamoDB reserved words.
        final Map <String, String> filterExpressionAttributeNames = new HashMap<>();
        filterExpressionAttributeNames.put("#hashAttribute", "ID");
        ...
        PaginatedScanList<KDAPItemsDO> results = mapper.scan(KDAPItemsDO.class, scanExpression);

        Iterator<KDAPItemsDO> resultsIterator = results.iterator();
        ...
        final List<KDAPItemsDO> batchOfItems = new LinkedList<KDAPItemsDO>();
